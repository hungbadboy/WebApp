...
private static void getChildRecords(DbxClientV1 client,String path) throws DbxException, IOException {
    		...
    		String[] str=child.path.split("/");
     		     ...
     		     try {
					...
					try {
						...
						downloadedFile = client.getFile(child.path, null,outputStream);
