...
brotControllers.directive('slideit',function() {
    return {
        ...
        +'<p>SibLinks! I appreciate this opportunity to educate & interact with students, besides earning substantially.</p>'
        +'<div class="author">'
        ...
        +'</a>'
        +'</div><!-- thumb-mainslider -->'
        +'<p>I have enjoyed the privilege of transforming academic life of many students by offering them a strong foundation in education.</p>'
        +'<div class="author">'
        +'<b>Landy Moore</b><span> - Harvard University faculty</span>'
        +'</div>'
        +'</div><!-- cont-mainslider -->'
...
brotControllers.directive('resize', function ($window) {
