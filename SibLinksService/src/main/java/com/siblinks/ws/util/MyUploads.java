...
public class MyUploads {
	 ...
	 * playlist ID for the list of videos uploaded to the user's channel, and
	 * then call the youtube.playlistItems.list method to retrieve the list of
	...
	public static void main(String[] args) {
		...
		// List<String> scopes =
		// Lists.newArrayList("https://www.googleapis.com/auth/youtube.readonly");
		List<String> scopes = Lists
				.newArrayList("https://www.googleapis.com/auth/youtubepartner");
		...
		try {
			...
			if (channelsList != null) {
				...
				// API response.
				String uploadPlaylistId = channelsList.get(0)
				 ...
				 * ().list("id,contentDetails,snippet,status");
				 */
				...
				playlistItemRequest
						.setFields("items(*),nextPageToken,pageInfo");
				...
				prettyPrint(playlistItemList.size(),
	 ...
	 */
	private static void prettyPrint(int size,
			Iterator<PlaylistItem> playlistEntries) throws IOException {
		System.out
				.println("=============================================================");
