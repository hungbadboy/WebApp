	...
	articalMgr.navGrid("#pager",
	    ...
	    {// options for the Edit Dialog
	    	...
	    	afterShowForm : function (formid) {
	    		...
	    		var myGrid = $('#articalMgr'),
	    	    selRowId = myGrid.jqGrid ('getGridParam', 'selrow'),
	    	    celValue = myGrid.jqGrid ('getCell', selRowId, 'authorId');
	    	...
	    	onclickSubmit: function(){
	    		var myGrid = $('#articalMgr'),
	    	    selRowId = myGrid.jqGrid ('getGridParam', 'selrow'),
	    	    celValue = myGrid.jqGrid ('getCell', selRowId, 'arId');
	    ...
	    {// options for the Add Dialog
	    	...
	    	onclickSubmit: function(){
	    		...
	    		$.ajax({
					...
					success : function(data) {
						if (data.request_data_result){
							$('#articalMgr').jqGrid('setGridParam',{datatype:'json'}).trigger('reloadGrid');
							return true;
						}
					}
	    		});
