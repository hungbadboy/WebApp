...
ngFileUpload.version = "12.2.12", ngFileUpload.service("UploadBase", ["$http", "$q", "$timeout", function (a, b, c) {
    function d(d) {
        function e(a) {
        ...
        c(function () {
            var c = d.$watch(f[g], function (c) {
                ...
                if ("ngfThumbnail" === g && (k || (k = {
                    ...
                    k = {width: parseInt(l.width.slice(0, -2)), height: parseInt(l.height.slice(0, -2))}
                }
    ...
    function a(a, c, d, e, f, g, h, i, j, k) {
        ...
        function p(b, c, e, f) {
            ...
            var m = r("ngfIncludeDir", a), n = [], o = 0, p = [i.emptyPromise()];
        ...
        c[0].addEventListener("dragover", function (b) {
            ...
            if (!l() && i.shouldUpdateOn("drop", d, a)) {
                b.preventDefault(), u(a) && b.stopPropagation(), s && c.removeClass(s),
                    s = null;
