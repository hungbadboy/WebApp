...
public class UploadVideo {
   ...
   // private static final String SAMPLE_VIDEO_FILENAME = "C:\\Users\\krkarnat\\Desktop\\test.mp4";
    ...
    public static void main(final String[] args) {
    	...
    	upload.upload("test.mp4",null);*/
    }

	    /**
	 *
	 */
    public void upload(final String fileName, final InputStream inputStream, final String subject, final String topic,
