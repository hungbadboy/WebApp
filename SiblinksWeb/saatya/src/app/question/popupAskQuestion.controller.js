//=========================================== HOME.CONTROLLER.JS==============
brotControllers.controller('popupAskQuestionController', ['$scope', '$http', '$location', '$rootScope', '$timeout', '$log', 'HomeService',  'myCache', 'QuestionsService','q_id',
    function ($scope, $http, $location, $rootScope, $timeout, $log, HomeService, myCache, QuestionsService,q_id) {
        var subjects = [];
        // check login page
        ...
        function init() {
            if (isEmpty(userId)) {
                $scope.askErrorMsg='Please login';
                return;
            }
        ...
        $scope.selectedQuestion = function (selected) {
            var pid = selected.originalObject.pid;
